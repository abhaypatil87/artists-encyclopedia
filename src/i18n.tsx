  ...
  resources: {
    ...
    fr: {
      translations: {
        ...
        artist_table_aria_label:
          "Un tableau présentant les artistes de votre recherche la plus récente",
        favourites_table_no_favourite:
          "Aucun artiste préféré n'a encore été enregistré!",
        favourites_table_aria_label:
        ...
        artist_actions_unset_all: "Tous les artistes favoris ont été effacés",
        artists_view_loading_search_results:
          "Chargement des résultats de recherche",
        artists_view_no_results_found: "Aucun résultat trouvé",
        artists_view_no_results_found_refine:
          "Aucun résultat trouvé. Veuillez affiner vos critères de recherche",
